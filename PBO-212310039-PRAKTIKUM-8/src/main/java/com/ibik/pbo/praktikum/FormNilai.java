...
public class FormNilai extends JFrame implements ActionListener {
    ...
    private void GUI(FormNilai frame) {
        GenerateMenuBar(this);
        GenerateForm(this);
        GenerateTable(this);
    }

    private void GenerateMenuBar(FormNilai frameMenu) {
    ...
    private void GenerateForm(FormNilai frameForm) {
    ...
    private void GenerateTable(FormNilai frameTable) {
        String[][] data = {
            {"212310018", "Fathur", "C"},
            {"212310019", "Rafi", "A"},
            {"212310020", "Subhan", "A"}
